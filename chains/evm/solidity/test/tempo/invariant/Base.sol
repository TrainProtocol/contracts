...
import {Actor} from "../../invariant/Actor.sol";
import {Clamp} from "../../invariant/utils/Clamp.sol";
import {DecimalPrinter} from "../../invariant/utils/DecimalPrinter.sol";
import {Deployer} from "../../invariant/utils/Deployer.sol";
import {vm} from "../../invariant/utils/Hevm.sol";
import {Logger} from "../../invariant/utils/Logger.sol";
import {Math} from "../../invariant/utils/Math.sol";
import {StringUtils} from "../../invariant/utils/StringUtils.sol";
import {EnumerableSet} from "../../invariant/utils/EnumerableSet.sol";
import {MockERC20} from "../../invariant/utils/MockERC20.sol";
...
/// @dev Ported from test/invariant/Base.sol, retargeted at src/tempo/Train.sol. The generic framework
///      pieces (Actor, utils/*) are reused as-is from test/invariant/ via relative import rather than
///      duplicated — they have no Train/Tempo-specific content. Everything here is already ERC20-only
///      (MockERC20), so no NATIVE_ETH/native-transfer adaptation was needed.
abstract contract Base is StringUtils, Clamp, Deployer, Math {
    ...
    function setup() internal {
        ...
        // Fund + approve every actor so userLock / solverLock can pull via transferFrom.
