...
///      from 11 to 10 entries accordingly.
contract FoundryInvariant is Test, Handlers {
    ...
    function setUp() public {
        ...
        s[4] = this.handler_redeemUser.selector;
        s[5] = this.handler_redeemSolver.selector;
        s[6] = this.handler_refundUser.selector;
        s[7] = this.handler_refundUserAsRecipient.selector;
        s[8] = this.handler_refundSolver.selector;
        s[9] = this.handler_skipTime.selector;
